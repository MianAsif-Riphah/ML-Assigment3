...
train_df = pd.read_csv(r"C:\Users\asif\Downloads\Compressed\results\train.csv")

# Read CSV test data file into DataFrame
test_df = pd.read_csv(r"C:\Users\asif\Downloads\Compressed\results\test.csv")
...
for sc in range(len(scoring)):
    ...
    gs = GridSearchCV(LogisticRegression(), return_train_score=True, param_grid=param_grid, scoring=scoring, cv=10,
                      refit='Accuracy')
